...
export default function ProjectCard({ project }: Props) {
  return (
    <div className="rounded-md bg-[#c4c4c4] py-5">
      ...
      <div className="bg-[#59687a] px-5 py-3 pl-7 text-white drop-shadow-md lg:min-h-[12vh] lg:-translate-x-3 lg:-translate-y-3 lg:rounded-md">
      ...
      <div className=" grid flex-initial grid-cols-2 grid-rows-1 py-5 text-black">
